...
class RefereeTest {
    ...
    void threeStrike() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(3, 0));
    }
    ...
    void twoStrike() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(2, 0));
    }
    ...
    void twoBall() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(0, 2));
    }
    ...
    void twoBall_oneStrike() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(1, 2));
    }
    ...
    void oneBall_oneStrike() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(1, 1));
    }
    ...
    void nothing() {
        ...
        assertThat(Referee.check(computer, player)).isEqualTo(new Result(0, 0));
    }
